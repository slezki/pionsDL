...
root_file = '/lustre/cms/store/user/slezki/Filtered/histo_y2s2y1spp_RS_2018MC_v2.root'
dataset_dir = '../dataset/'
...
pP_variables = ['pionP_charge','pionP_dxy', 'pionP_dz', 'pionP_dRwithDimuon', 'pionP_fromPV'] # base features for pi+
pM_variables = ['pionM_charge','pionM_dxy', 'pionM_dz', 'pionM_dRwithDimuon', 'pionM_fromPV'] # base features for pi-
...
print(dfy1s_t.head())
print('Len: {}'.format(len(dfy1s_t)))

print(dfy1s_f.head())
print('Len: {}'.format(len(dfy1s_f)))
...
dfy1s_t.to_hdf(dataset_dir + 'pions.h5', "true_Y1S")
dfy1s_f.to_hdf(dataset_dir + 'pions.h5', "fake_Y1S")
